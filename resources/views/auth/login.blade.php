                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="identify" type="text" class="form-control @error('mobile') is-invalid @enderror @error('email') is-invalid @enderror" name="identify" value="{{ old('identify') }}" required >
